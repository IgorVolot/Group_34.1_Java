...
class AlbumTest {
    ...
    void addPhoto() {
        ...
        Photo photo = new Photo(2, 5, "title5", "url3", now.minusDays(5));
        assertTrue(album.addPhoto(photo));
        assertEquals(7, album.size());
        photo = new Photo(2, 6, "title6", "url4", now.minusDays(5));
    ...
    @Test
    void updatePhoto() {
        assertTrue(album.updatePhoto(1, 4, "url2"));
        assertEquals("url2", album.getPhotoFromAlbum(1, 1).getUrl());
    }
