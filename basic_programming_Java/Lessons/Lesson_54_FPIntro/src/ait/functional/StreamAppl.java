...
public class StreamAppl {
    public static void main(String[] args) {
        ...
        numbers.stream()
                .filter(a -> a > 3)
                .peek(a -> System.out.println("peek before sort: " + a))// вместо дебагирования
...
//                .toArray(size -> new Integer[size]);
        ...
        res = Arrays.stream(arr)
                ...
                .filter(n -> n % 4 == 0)
                .findFirst()
                .orElse(Integer.MAX_VALUE); // Integer.MAX_VALUE - doesn't matter what you put here (null, 0, ..., 42)
